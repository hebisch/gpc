{ GPC demo unit to show how to include Pascal code in C programs.
  ...
  along with this pro-gram; see the file COPYING. If not, write to
  the Free Software Foundation, Inc., 59 Temple Place - Suite 330,
  Boston, MA 02111-1307, USA.

  As a special exception, if you incorporate even large parts of the
  code of this demo pro-gram into another pro-gram with substantially
  different functionality, this does not cause the other pro-gram to
